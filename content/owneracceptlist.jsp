<%@ page language="java" contentType="text/html; charset=utf-8" pageEncoding="utf-8"%>
            ...
            <div class="container-fluid">
				...
				<div class="box-header">
					<div class="box-name">
						<i class="fa fa-coffee"></i> <span>业主验收</span>
					</div>
					<div class="box-icons"> 
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="box ui-draggable ui-droppable" id="dept">
				<div class="box-header">
					<div class="box-name">
						<i class="fa fa-search"></i> <span>业主验收</span>
					</div>
					<div class="box-icons">
						<a class="collapse-link"> <i class="fa fa-chevron-up"></i>
						</a> <a class="expand-link"> <i class="fa fa-expand"></i>
		    ...
		    "commands": function(column, row)
		    {
	    	    ...
	    	    grid.find(".command-run1").on("click", function(e)
	    	    {
	    	    	...
	    	    	$.post("dealtask",{"taskId":taskId},function(data){
	    	    		...
	    	    		$("form").attr("action","task/yzcomplete/"+taskId);
	    	    	});
	    	    	$("#dept").show();
	    	    	$("#btn").click(function(){
	    		    	$.post("task/yzcomplete/"+taskId,$("form").serialize(),function(a){
	    		    		alert("业主验收完成");
	    		    		LoadAjaxContent("owneraccept");
	    		    	});
