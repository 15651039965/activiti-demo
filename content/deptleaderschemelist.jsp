<%@ page language="java" contentType="text/html; charset=utf-8" pageEncoding="utf-8"%>
            ...
            <div class="container-fluid">
				...
				<div class="box-header">
					<div class="box-name">
						<i class="fa fa-coffee"></i> <span>项目经理提供方案</span>
					</div>
					<div class="box-icons">
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="box ui-draggable ui-droppable" id="dept">
				<div class="box-header">
					<div class="box-name">
						<i class="fa fa-search"></i> <span>项目经理提供方案</span>
					</div>
					<div class="box-icons">
						<a class="collapse-link"> <i class="fa fa-chevron-up"></i>
						</a> <a class="expand-link"> <i class="fa fa-expand"></i>
						...
						<form role="form" action="" method="post">
                                 <div class="form-group">
						           ...
						           <div class="form-group">
						             ...
						             <div class="form-group">
						                <label>施工方案</label>
						                <input class="form-control" id="scheme" readonly="readonly">
						              </div>
						              <div class="form-group">
						                <label>施工预算</label>
						                <input class="form-control" id="budget" readonly="readonly">
						              </div>
						              <div class="form-group">
						                <label>施工照片</label>
						                <input class="form-control" id="epicture">
						              </div>
		    ...
		    "commands": function(column, row)
		    {
	    	    ...
	    	    grid.find(".command-run1").on("click", function(e)
	    	    {
	    	    	...
	    	    	$.post("dealtask",{"taskId":taskId},function(data){
	    	    		...
	    	    		$("form").attr("action","task/deptleaderschemecomplete/"+taskId);
	    	    	});
	    	    	$("#dept").show();
	    	    	$("#btn").click(function(){
	    		    	$.post("task/deptleaderschemecomplete/"+taskId,$("form").serialize(),function(a){
	    		    		alert("方案完成");
	    		    		LoadAjaxContent("deptleaderschemelist");
	    		    	});
